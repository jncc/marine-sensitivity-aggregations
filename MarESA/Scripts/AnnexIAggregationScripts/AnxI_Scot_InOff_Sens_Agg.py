...
# Script description:    Aggregate MarESA sensitivity assessments for Scottish Inshore & Offshore Habitats Directive
#                        Annex I Features and Sub-Features.
...
def main(marESA_file, Scot_Annex1):
    ...
    annex_unknown = annex_unknown_template_cjoin[
        ['Annex I Habitat', 'Annex I sub-type', 'Depth zone', 'Biotope name', 'JNCC code', 'JNCC name',
    ...
    annex_maresa_unknowns = annex_maresa_unknowns[[
        'Annex I Habitat', 'Annex I sub-type', 'Depth zone', 'Biotope name',
        'JNCC code', 'JNCC name', 'Pressure', 'Resilience', 'Resistance', 'Sensitivity'
    ]]
    ...
    annex_maresa_unknowns['Depth zone'] = annex_maresa_unknowns['Depth zone'].str.strip()
    ...
    # aggregated
    annex_maresa_unknowns['FeatureSubFeatureDepth'] = annex_maresa_unknowns.apply(lambda row: together(row), axis=1)
