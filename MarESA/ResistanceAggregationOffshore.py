...
# Aggregate MarESA resistance assessments for UK offshore biotopes on spatial location and
...
def main(marESA_file, bioregions_ext):
    ...
    L6_processed[[
        ...
        'Unknown'
    ]] = L6_processed.apply(lambda df: pd.Series(ml.counter_rt(df['Resistance'])), axis=1)
    ...
    aggregated_L6_to_L5[[
        'High', 'Medium', 'Low', 'None', 'Not sensitive', 'Not relevant', 'No evidence', 'Not assessed',
        'Unknown'
    ]] = aggregated_L6_to_L5.apply(lambda df: pd.Series(ml.counter_rt(df['Resistance'])), axis=1)
    ...
    L4_agg[['High', 'Medium', 'Low', 'None', 'Not sensitive', 'Not relevant', 'No evidence', 'Not assessed',
            'Unknown']] = L4_agg.apply(lambda df: pd.Series(ml.counter_rt(df['Resistance'])), axis=1)
    ...
    L3_agg[['High', 'Medium', 'Low', 'None', 'Not sensitive', 'Not relevant', 'No evidence', 'Not assessed',
            'Unknown']] = L3_agg.apply(lambda df: pd.Series(ml.counter_rt(df['Resistance'])), axis=1)
    ...
    L2_agg[['High', 'Medium', 'Low', 'None', 'Not sensitive', 'Not relevant', 'No evidence', 'Not assessed',
            'Unknown']] = L2_agg.apply(lambda df: pd.Series(ml.counter_rt(df['Resistance'])), axis=1)
